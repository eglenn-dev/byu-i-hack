    ...
    <div className="h-20 flex flex-row justify-between items-center bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text pl-2 pr-2">
      ...
      <div className="flex flex-row">
        ...
        <form action={async () => {
          "use server";
          await logout();
        }}><button type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 24 24"><path fill="currentColor" d="M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h7v2H5v14h7v2zm11-4l-1.375-1.45l2.55-2.55H9v-2h8.175l-2.55-2.55L16 7l5 5z"></path></svg></button></form>
      </div>
    </div>
  );
};
