...
const Header = () => {
  return (
    <div className="flex flex-row bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text pl-2 pr-2">
      ...
      <div className="hidden sm:block absolute right-10 mt-3">
        <Link href="/dashboard/form" className="m-auto">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="3em"
            height="3em"
